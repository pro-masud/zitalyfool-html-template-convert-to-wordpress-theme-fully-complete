...
function honeyhome_scripts() {
	wp_enqueue_style( 'honeyhome-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'honeyhome-style', 'rtl', 'replace' );

	wp_enqueue_script( 'honeyhome-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
